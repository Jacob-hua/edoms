<template>
  <div :key="fieldKey" class="m-fields-code-select">
    <ElCard shadow="never">
      <template #header>
        <m-fields-select
          :config="selectConfig"
      ...
      <div class="tool-bar">
        <ElTooltip class="tool-item" effect="dark" content="查看代码块" placement="top">
          <svg
...
import { ElCard, elMessage, ElTooltip } from '@edoms/design';
import { SelectConfig } from '@edoms/form';
