<template>
  <ElScrollbar
    class="edoms-editor-layer-panel"
...
import { ElInput, ElScrollbar, ElTree } from '@edoms/design';
import type { Id, MNode, MPage } from '@edoms/schema';
...
watch(isMultiSelectStatus, () => {
  // 多选模式如果已存在第一个选中的元素是页面(edoms-ui-page) 剔除页面选中状态
