        ...
        <div class="content-body">
          ...
          <div class="body-con">
            ...
            <div class="screen-card">
              <ItemCard v-for="item in dataCard" :key="item.name" :option="item"></ItemCard>
            </div>
          </div>
        </div>
      </div>
...
const dataCard = [
  { name: '1-1充电桩', switch: '1', charging: '60', remainder: '1小时30分钟', select: false, state: 'normal' },
  { name: '1-2充电桩', switch: '1', charging: '60', remainder: '1小时30分钟', select: true, state: 'normal' },
  { name: '1-3充电桩', switch: '0', charging: '-', remainder: '1小时30分钟', select: false, state: '故障' },
  { name: '1-4充电桩', switch: '0', charging: '-', remainder: '1小时30分钟', select: false, state: '待机' },
  { name: '1-5充电桩', switch: '0', charging: '-', remainder: '1小时30分钟', select: false, state: '摘枪' },
  { name: '1-6充电桩', switch: '1', charging: '60', remainder: '1小时30分钟', select: false, state: 'normal' },
  { name: '1-7充电桩', switch: '1', charging: '60', remainder: '1小时30分钟', select: false, state: 'normal' },
  { name: '1-8充电桩', switch: '1', charging: '60', remainder: '1小时30分钟', select: false, state: 'normal' },
  { name: '1-9充电桩', switch: '1', charging: '60', remainder: '1小时30分钟', select: false, state: 'normal' },
  { name: '1-10充电桩', switch: '1', charging: '60', remainder: '1小时30分钟', select: false, state: 'normal' },
  { name: '1-11充电桩', switch: '1', charging: '60', remainder: '1小时30分钟', select: false, state: 'normal' },
  { name: '1-12充电桩', switch: '1', charging: '60', remainder: '1小时30分钟', select: false, state: 'normal' },
  { name: '1-13充电桩', switch: '1', charging: '60', remainder: '1小时30分钟', select: false, state: 'normal' },
  { name: '1-14充电桩', switch: '1', charging: '60', remainder: '1小时30分钟', select: false, state: 'normal' },
  { name: '1-15充电桩', switch: '1', charging: '60', remainder: '1小时30分钟', select: false, state: 'normal' },
];
