...
const curdeviceTypeCode = ref();
const deviceList: any = ref([]);
const curDeviceCode = ref();
const deviceRunParams = ref([]);

const typeChange = (item: any) => {
  curdeviceTypeCode.value = item.devType;
  getDeviceList();
};
const getDeviceList = () => {
...
const tabScrollChange = (item: any) => {
  curDeviceCode.value = item.tpl;
  getDeviceRunParams();
};
const getDeviceRunParams = async () => {
  deviceRunParams.value = [];
