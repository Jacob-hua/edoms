 ...
 * 选中框
 */
export default class StageDragResize extends EventBus {
  ...
  private bindDragEvent(): void {
    ...
    this.moveable
        ...
        timeout = globalThis.setTimeout(async () => {
          ...
          for (const el of els) {
            if (
              ...
              dom.addClassName(el, doc, this.core.containerHighlightClassName);
              break;
            }
          }
      ...
      .on('dragEnd', () => {
        ...
        if (doc) {
          parentEl = dom.removeClassNameByClassName(doc, this.core.containerHighlightClassName);
        }
